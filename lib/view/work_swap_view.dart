...
class _WorkSwapState extends State<WorkSwap> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(child: Consumer<WorkSwapViewModel>(
                    ...
                    child: Row(
                        ...
                        children: [
                          IconButton(onPressed: (){
                            setState(() {
                              prov.changeDate(prov.week.subtract(const Duration(days: 7)));
                            });
                          ...
                          IconButton(onPressed: (){
                            setState(() {
                              prov.changeDate(prov.week.add(const Duration(days: 7)));
                            });
